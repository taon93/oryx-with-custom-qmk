...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [4] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, ST_MACRO_16,    ST_MACRO_17,    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, ST_MACRO_10,    ST_MACRO_11,    ST_MACRO_12,    ST_MACRO_13,    KC_TRANSPARENT,                                 ST_MACRO_18,    ST_MACRO_19,    ST_MACRO_20,    ST_MACRO_21,    ST_MACRO_22,    KC_TRANSPARENT, 
    KC_TRANSPARENT, ST_MACRO_14,    KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_15,    KC_TRANSPARENT,                                 ST_MACRO_23,    ST_MACRO_24,    ST_MACRO_25,    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
...
const uint16_t PROGMEM combo16[] = { OSM(MOD_LALT), OSM(MOD_LCTL), COMBO_END};
const uint16_t PROGMEM combo17[] = { KC_LCBR, KC_DLR, COMBO_END};
const uint16_t PROGMEM combo18[] = { KC_AMPR, KC_GRAVE, COMBO_END};
const uint16_t PROGMEM combo19[] = { KC_UNDS, KC_LPRN, COMBO_END};
const uint16_t PROGMEM combo20[] = { KC_SLASH, KC_PERC, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(combo18, KC_TAB),
    COMBO(combo19, KC_DOT),
    COMBO(combo20, KC_COMMA),
};
