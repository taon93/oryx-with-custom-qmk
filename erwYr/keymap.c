...
#define DUAL_FUNC_4 LT(10, KC_F20)
...
const uint16_t PROGMEM combo16[] = { KC_L, KC_SPACE, COMBO_END};
const uint16_t PROGMEM combo17[] = { KC_SPACE, KC_X, COMBO_END};
const uint16_t PROGMEM combo18[] = { MT(MOD_LALT, KC_N), KC_SPACE, COMBO_END};
const uint16_t PROGMEM combo19[] = { KC_SPACE, KC_Q, COMBO_END};
const uint16_t PROGMEM combo20[] = { MT(MOD_RALT, KC_A), KC_SPACE, COMBO_END};
const uint16_t PROGMEM combo21[] = { MT(MOD_RCTL, KC_E), KC_SPACE, COMBO_END};
const uint16_t PROGMEM combo22[] = { MT(MOD_RGUI, KC_C), KC_SPACE, COMBO_END};
const uint16_t PROGMEM combo23[] = { KC_O, KC_SPACE, COMBO_END};
const uint16_t PROGMEM combo24[] = { KC_SPACE, KC_Z, COMBO_END};
const uint16_t PROGMEM combo25[] = { KC_F, KC_O, KC_U, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(combo17, PL_02),
    COMBO(combo18, PL_05),
    COMBO(combo19, ST_MACRO_24),
    COMBO(combo20, PL_09),
    COMBO(combo21, PL_07),
    COMBO(combo22, PL_08),
    COMBO(combo23, PL_04),
    COMBO(combo24, PL_01),
    COMBO(combo25, QK_REP),
};
